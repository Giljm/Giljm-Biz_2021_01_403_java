...
public class ClassServiceV4 {
	...
	/*
	 * method 선언문에 변수선언키워드(int, float ...)이 있으면 이 키워드를 return type이라고 부른다.
	 */
	public int result() { // 선언문
		 ...
		 */
		return sum; // for문이나 while문 밖에서도 사용가능
	...
	/*
	 * method 선언문에 void 이외의 return type이 있을 경우 method에는 반드시 return 명령문이 value와 함께
	 * 나타나야 한다.
	 */
