...
public class ClassServiceV2 {
	...
	public void times() {
		/*
		 * num1 과 mum2는 add() method에도 선언되어 있지만 선언된 method가 다르므로 이름만 같을뿐 전혀 다른 변수다.
		 */
	...
	public void input() {
		 ...
		 * 
		 * input() method가 호출 될때마다 키보드 입력을 받기 위해 Scanner 클래스를 객체 만들고
	...
	public void division() {
		 ...
		 * 
		 * 현재 클래스 (Css..V2)가 객체로 선언되고 인스턴스로 만들어질때 1번만 키보드에 연결된다
		 * 필요에 따라 키보드 입력을 기다리는 nextInt() 메서드를 자유롭게 사용가능하다.
		 * 
