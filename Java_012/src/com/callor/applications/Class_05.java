...
public class Class_05 {
	public static void main(String[] args) {
		...
		/*
		 * ()안의 값, 변수값, 연산식의 결과를 Console에 출력 출력한 후 자동 줄바꿈을 하여 이후 출력되는 결과가 다음줄에 출력되도록 하는
		 * 기능
		 * 
		 * ()안에 아무것도 없으면 아무것도 없으면 빈줄만 출력
		 * 
		 */
		System.out.println();
		...
		/*
		 * ()안의 값, 변수값, 연산식 등을 Console에 표시 단, 출력후 줄바꿈을 하지 않아 이후 출력되는 결과가 이어서(옆으로) 출력 또한,
		 * ()안의 내용을 생략할 수 없다.
		 */
		System.out.print("30");
