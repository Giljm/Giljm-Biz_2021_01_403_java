...
/*
 * 쇼핑몰에서 판매되는 상품을 관리하기 위한 데이터를 처리할 용도의 Value Object 클래스 다자인(설계)
 * 
 * ProductVO 클래스는
...
public class ProductVO {
	...
	/*
	 * java 에서는 class를 선언하면
	 * public String toString() 메서드가 자동으로 생성된다.
	 * 하지만 기본적으로 코드는 보이지 않는다.
	 * toString() 메서드는 객체를 생성했을때 어떤 클래스를 사용했는지 와
	 * 생성된 객체가 컴퓨터 기억장치에 어떤 곳(주소)에 만들어져 저장되어 있는지 알려주는
	 * 코드가 담겨있다.
