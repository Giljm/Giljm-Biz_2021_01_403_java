...
/*
 * 여기에 작성되는 내용은 주석문 (coment)
 * java 코드와 관계없이 설명하는 문장
 * 참고하는 문장 등을 작성 할 수 있는 곳
 * 
 ...
 * 
 * Java class
 * - java 언어 문법에 맞도록 작성된 파일
 * - public class 키워드로 시작을 하고
 * - 임의로 이름을 작성하여 만든다
 *   여기에서는) Hello
 * - Hello.java 라는 파일에 코드가 저장된다
 * - 클래스 이름과 파일이름은 항상 같아야한다
 * - 클래스가 HelloKorea이면 HellowKorea.java로 작성을 한다
 * 
 * - 클래스 이름은 첫 글자가 반드시 영문 대문자
 * - 영문 대소문자, 숫자, _(Under bar, Under Score)
 * 
 * - 두 개 이상의 단어를 조합할때는 Camel Case로 한다
 * 
 */
public class HelloKorea {
	...
	public static void main(String args[]) {
		 ...
		 *  - "" 표시 내의 내용을 그대로 Console 출력 ""로 묶인 내용을 '문자열, String' 이라고 한다.
