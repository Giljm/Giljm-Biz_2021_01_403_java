...
// 코드가 아닌 것으로 무시하는 문장이다.
	...
	public static void main(String[] args) {
		...
		/*
		 * 큰 따음표 안에 있는 문장은 문자열이라고 부른다.
		 * ""(더블 쿼테이션 마크)
		 * ''(싱글 쿼테이션 마크)
		 * ""내에 있는 글자, 단어 등을 문자열이라고 한다.
		 * 문자열 리터럴
		 * String 리터럴
		 */
...
//숫자 30과 40을 덧셈하여
//Console에 출력하라
//연산부호(+,-,/,*)와 숫자사이는 빈칸의 개수가 아무런 문제가 없다.
//하지만 가독성을 위하여 빈칸을 한칸씩 넣어주자
...
/*연산
 * 숫자, 숫자는 4칙 연산을 모두 수행할 수 있다.
 * 숫자, 숫자의 4칙 연산은 수학의 연산규칙과 같다.
